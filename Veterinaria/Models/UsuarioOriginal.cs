...
namespace Veterinaria.Models
{
    public class UsuarioOriginal
    {
        ...
        [RegularExpression("^[A-Za-zÁÉÍÓÚáéíóúñÑ ]{1,30}$", ErrorMessage = "Solo letras en el Campo Nombre")]

        [DisplayName("Nombre")]
        public string NOMBRES { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessage = "Ingrese Apellido del Usuario")]
        [RegularExpression("^[A-Za-zÁÉÍÓÚáéíóúñÑ ]{1,30}$", ErrorMessage = "Solo letras en el Campo Apellido")]

        [DisplayName("Apellido")]
        public string APELLIDOS { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessage = "Ingrese Direccion del Usuario")]
        [RegularExpression("^[A-Za-zÁÉÍÓÚáéíóúñÑ0-9 ]{1,60}$", ErrorMessage = "Ingrese una dirreccion con menos de 40 letras")]
        ...
        [RegularExpression("^[A-Za-zÁÉÍÓÚáéíóúñÑ0-9 ]{1,15}$", ErrorMessage = "El Nickname debe ser menos de 10 letras")]

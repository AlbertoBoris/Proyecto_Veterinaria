...
namespace Veterinaria.Models
{
    public class MascotaOriginal
    {
        ...
        [RegularExpression("^[A-Za-zÁÉÍÓÚáéíóúñÑ ]{1,30}$", ErrorMessage = "Solo letras en el Campo Animal")]
        [DisplayName("Animal")]
        public string ANIMAL { get; set; }

        [Required(AllowEmptyStrings = false, ErrorMessage = "Ingrese Raza")]
        [RegularExpression("^[A-Za-zÁÉÍÓÚáéíóúñÑ ]{1,40}$", ErrorMessage = "Solo letras en el Campo Raza")]
        [DisplayName("Raza")]
